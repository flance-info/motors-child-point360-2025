...
<div class="stm_add_car_form_1">
	<div class="stm-car-listing-data-single stm-border-top-unit ">
		<div class="title heading-font"><?php esc_html_e('Udfyld k&oslash;ret&oslash;jets oplysninger', 'motors-elementor-widgets'); ?></div>
		<p>UDFYLD ALLE DATA OM DIT K&Oslash;RET&Oslash;J. ER DU I TVIVL? ER DU ALTID VELKOMMEN TIL, AT KONTAKTE VORES KUNDESERVICE</p>
	</div>
					...
					<div class="col-md-3 col-sm-3 stm-form-1-selects">
						...
						<?php else : ?>
							<select class="add_a_car-select" data-class="stm_select_overflowed"
								...
								<option value=""
										selected="selected"><?php esc_html_e('V&aelig;lg ', 'motors-elementor-widgets'); ?><?php echo esc_html($tax_name); ?></option>
								<?php
								if (!empty($terms)) :
			...
			if ($details_location) :
				...
				<div class="stn-add-car-location-wrap">
					<div class="stm-car-listing-data-single">
						<div class="title heading-font"><?php esc_html_e('HVOR BEFINDER K&Oslash;RET&Oslash;JET?', 'motors-elementor-widgets'); ?></div>
						<p>INDTAST BLOT POSTNR ELLER BYNAVN OG SYSTEMET FINDER AUTOMATISK LATITUDE OG LONGTITUDE<p/>
					</div>
					<div class="stm-form-1-quarter stm_location stm-location-search-unit">
						<div class="stm-location-input-wrap stm-location">
							<div class="stm-label">
								...
								<?php esc_html_e('Indtast Postnr eller By', 'motors-elementor-widgets'); ?>
							</div>
							<input type="text" name="stm_location_text"
								...
								<?php } ?> id="stm-add-car-location" value="<?php echo esc_attr($data_value); ?>"
								   placeholder="<?php esc_attr_e('Postnr eller By', 'motors-elementor-widgets'); ?>"/>
						</div>
						<div class="stm-location-input-wrap stm-lng">
							...
							<input type="text" class="text_stm_lat" name="stm_lat"
								   ...
								   placeholder="<?php esc_attr_e('Indhenter Automatisk', 'motors-elementor-widgets'); ?>"/>
						</div>
						<div class="stm-location-input-wrap stm-lng">
							<div class="stm-label">
								<i class="stm-service-icon-pin_2"></i>
